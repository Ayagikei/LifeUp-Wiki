...
1. **登入賬號不匹配：** 請確保您使用的登入賬號與購買會員時使用的賬號一致。部分老版本的使用者可能會將賬號繫結於不常用的Google賬號，或者有多個微博、QQ小號。
...
如果您仍然無法找回您的會員，您可以提供原始兌換碼或自動化購買時的商家訂單號，傳送至 li，我們將協助您進行排查或者換綁渠道。請注意，由於第三方授權登入的特殊性，我們只能查詢到對應的登入渠道和部分資訊，無法對應到具體的第三方賬號（例如QQ號、微訊號）。

...
以及能夠滿足日常的簡易待辦記錄、習慣統計等功能，並不強制關聯時間。

但`人升`並不是一款日程管理、專案管理型應用，它並不適合用於繁雜的日程管理工作。

這之間的差異，可檢視系統自帶的`待辦`軟體和`日曆`軟體之間的差異。
...
>
> 如果你想要的是副本合作遊戲化待辦事項，可以嘗試《Habitica》。
...
也可以藉由下述的 APIs 功能，在你所指定的場景自動化新增計時。
...
<p align="center">社羣相關的 app 已經足夠多了。這裏沒有社交元素，只有一個讓你分享動態和創造的小世界！</p>

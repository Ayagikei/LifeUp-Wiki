...
>  提示：如果你是透過 Google Play 購買的 人升。由於我們和 Google 都深知一款應用難以滿足所有人，只要你在購買後一段時間內解除安裝 人升 即可獲得退款。如果你已經超過了退款期限，仍可聯絡我們的郵箱獲得幫助 lifeup@ulives.io 。
...
**如果你想要在電腦端使用《人升》，**爲了保持資料一致，建議使用各手機廠商提供的投屏、跨屏同聯功能，或者使用第三方的 scrcpy 投屏軟體。
...
**如果無法解決或需要反饋，可以加入我們的頻道或討論群（爲了讓你能更快地解決問題，請務必先閱讀常見問題自查，並且請提供清晰的問題反饋~）：**
...
我們也會非常歡迎透過 https://github.com/Ayagikei/LifeUp/issues 提交問題或建議工單。

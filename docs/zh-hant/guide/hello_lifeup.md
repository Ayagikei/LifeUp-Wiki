...
目前《人升》沒有 iOS 版本。
**但我們已經推出了專門為 iOS 使用者設計的效率應用 [ulives](https://apps.apple.com/us/app/ulives-gamify-your-tasks/id6743084261)！它繼承了人升的核心理念，並針對蘋果生態系統進行了最佳化。**

**如果你想在電腦端使用《人升》**，為保持資料一致，建議優先使用廠商提供的投屏/跨屏功能，或使用第三方工具 `scrcpy`。

**如果你使用的是 iOS 端，想體驗《人升》類似的應用：**

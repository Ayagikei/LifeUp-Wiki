...
| limitId | 關聯目標 ID | 數字 | 否* | 屬性 / 物品 / 任務 / 成就類規則需要 |
...
| 引數   | 含義     | 取值 | 示例             | 是否必須 | 備註                                                         |
| ------ | -------- | ---- | ---------------- | -------- | ------------------------------------------------------------ |
| result | 結果碼   | 數字 | 0                | 是       | 0 - 使用成功<br/>1- 資料庫異常<br/>2 - 經驗值不足限制<br/>3 - 找不到商品<br/>4 - 執行倒計時衝突<br/>5 - 庫存不足<br/>6 - 商品不可使用<br/>7 - 金幣限制<br/>8 - 目標庫存限制<br/>9 - 屬性等級限制<br/>10 - 時間限制<br/>11 - 擁有物品數量限制<br/>12 - 任務完成限制<br/>13 - 成就解鎖限制<br/>14 - 週期數量限制 |

...
2. **商店物品使用效果升級**：新增隨機經驗值、庫存變更、播放音效、倒計時等效果，並最佳化配置流程。
...
8. **桌面小部件任務過濾增強**：新增“摺疊未開始事項”過濾，減少列表干擾。
9. **高階使用者：API 能力增強**：URL Scheme API 新增/增強任務模板管理、重複結束條件、合成篩選跳轉等能力。

...
​    收集個人資訊型別：**裝置資訊 (bssid、MAC、SSID) 地址、；網路連通狀態資訊(Wifi連通狀態資訊）**
...
你有權自主登出賬號，當你處於登入狀態時，可以前往[側邊欄]-[設定]-[資料資料/恢復/清除]頁面，往下滑動至[刪除賬號（伺服器資料）]一欄登出賬號和刪除賬號資訊。

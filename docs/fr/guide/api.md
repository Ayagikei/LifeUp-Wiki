...
Les gestionnaires URL Scheme ne lisent que les paramètres query listés dans le tableau de chaque méthode. Les paramètres supplémentaires sont ignorés ; la requête peut quand même réussir.

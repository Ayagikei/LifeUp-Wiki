...
> [!NOTE]
> نحن نطرح **LifeUp v1.106.0** و**LifeUp Cloud v3.0.0** تدريجياً. نظراً لاختلاف جداول مراجعة المنصات، قد يُحدَّث هذا التوثيق قبل أن تصبح التطبيقات متاحة على نطاق واسع؛ وقد يكون تاريخ الإصدار الفعلي لاحقاً لما تراه هنا.

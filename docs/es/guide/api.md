...
Los controladores URL Scheme solo leen los parámetros query que aparecen en la tabla de cada método. Los parámetros extra se ignoran; la petición puede seguir teniendo éxito.

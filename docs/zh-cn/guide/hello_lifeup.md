<h1 align="center" padding="100">进入 LifeUp 的世界</h1>
...
`人升`是一款清单待办事项类型的应用，其重复机制足以支撑习惯养成。

以及能够满足日常的简易待办登记、习惯统计等功能。

但`人升`并不是一款日程管理、项目管理型应用，它并不适合用于繁杂的日程管理工作。

这之间的差异，相当于系统自带的`待办`软件和`日历`软件。

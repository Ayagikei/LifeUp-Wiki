...
##### 1. 自建任务模板
你可以使用「冻结」与「复制」功能创建自己的任务模板。
比如设置好运动类任务相关的奖励，将其「冻结」，下次就只需要「复制」任务然后编辑即可。

<br/>

##### 2. 冻结和归档

如果你一段时间内不需要完成某个重复任务，你可以长按并「冻结」它。冻结的任务不会产生失败记录和惩罚。

也可以使用「冻结」与「清单归档」功能实现类似任务归档封存的需求。

...
>  提示：如果你是通过 Google Play 购买的 人升。由于我们和 Google 都深知一款应用难以满足所有人，只要你在购买后一段时间内卸载 人升 即可获得退款。如果你已经超过了退款期限，仍可联系我们的邮箱获得帮助 lifeup@ulives.io 。
...
<p align="center">Customize your own gamified list with attributes, EXP, coins, and rewards to stay productive!</p>
...
如果你想要的是一款云端同步应用，可以考虑使用下述商业化应用，或将它们与`人升`搭配使用。**如果你正是想要一款离线存储应用，那么`人升`刚好适合你！**

你可以查阅[如何设置备份](guide/backup)了解更多，现在先继续往下看吧~
稍后我们会介绍应用的各种有趣特性。
...
这是一款“记录”软件，待办事项、习惯类应用皆是如此。如果你需要所谓的“督促”，建议找小伙伴一起进步。

#### # 独立开发

**独立**

这是一款由两人利用业余时间独立开发的应用，并由用户自主宣传、建设社区而成的小应用。因此我们不会、也没有资源聚焦于一些高成本的商业化功能，如“社交”、“服务器同步”、“任务分派”。
...
同时，`人升`也是一款使用纯 Android 原生技术开发的应用，以便深度利用 Android 的系统能力并提供极致的流畅体验。
...
**如果你想要在电脑端使用《人升》，**为了保持数据一致，建议使用各手机厂商提供的投屏、跨屏同联功能，或者使用第三方的 scrcpy 投屏软件。

**如果你是 iOS 用户，想体验类似《人升》的应用：**

**1. 推荐尝试我们的 iOS 应用 [ulives](https://apps.apple.com/us/app/ulives-gamify-your-tasks/id6743084261)。**
2. 使用电脑 Android 模拟器或 Windows 11 安卓子系统（WSA）体验《人升》。
3. 或者使用其他优秀的同类应用。

> 我们有跨平台开发计划，但因能力有限，短期内无法完成从零开始的学习和开发。具体规划和原因请查看下面的《常见问题》。
...
由于目前安卓权限收紧很严重，各品牌机型也有着不同的限制。为了你能够正常使用应用的各项机制，请进行兼容性配置。

#### # 操作指引
应用内基本都是点按操作，但有下述两点可能需要留意一下：
- 应用内的绝大部分卡片编辑/删除等操作都需要“长按卡片”弹出菜单

（这也是 Android 的推荐交互方式，而侧滑菜单常见于 iOS）
...
**如果无法解决或需要反馈，可以加入我们的频道或讨论群（为了让你能更快地解决问题，请务必先阅读常见问题自查，并且请提供清晰的问题反馈~）：**

#### QQ群 / QQ频道

##### 加入QQ频道
- **无任何人数**限制，且频道支持按不同分类进行专题讨论，我们强烈推荐您加入。
    - 频道入口：[点此进入](https://pd.qq.com/s/c61ihv4mf)

对于不常使用 QQ 的用户，您可以选择以下两种方式之一加入：
- 使用微信扫描二维码，可通过小程序便捷访问频道。
...
> - **由于群人数有限，我们可能会不定期清理非活跃用户**，以便新用户可以加入讨论。若因此被清理，当你遇到新问题时，欢迎随时重新加入。你也可以选择加入不限人数的 QQ 频道作为替代。
> - 讨论需要遵循友善、尊重的前提，对于不友善的用户或者行为，我们可能会永久禁止加入相关社群。
> - 这是用户交流群，而非会员专属售后群。因此上述规则对所有成员（无论是否会员）一视同仁。
...
人升采用模块化设计，你可以仅启用自己需要的功能模块。

但它们也支持灵活组合，发挥出 1+1>2 的效果，实现非常强大的组合效果。

`人升`会提供**多样的单一职能功能（比如“开箱”本身只是一个单纯的随机功能）**，多个单一功能组合可以实现多种可能性：
...
功能模块介绍后也有用户贡献的体系建设文章和 B 站视频，参考他人的体系能获得不少灵感。
...
<p align="center">任务是一切的基石。给自己发布任务、设置奖励，并努力挑战自我吧！</p>
...
因此任务纯粹只是个“记录”工具，辅助你记录现实中的“完成”情况，协助你进行奖惩控制。

而不会承担过多的自动化计算操作，这类操作是交由“成就”处理的。
...
当然，**如果你习惯于次日凌晨打卡，也可以调整该时间（比如调整到第二天凌晨 2 点）。**

<br/>

!> **“无期限”**意味着任务不会自动逾期或重复，在绝大多数场景下，你只需要保持默认期限，并不需要设置成“无期限”。

<br/>

**开始时间**

它主要用于设置在未来才开始展示的**单次任务**，

或者为**重复任务**限制打卡时间段（比如早起任务限制 6:00 才能开始打卡）。

**# 例如，你设置了一个当天中午 14 点截止的任务：**
...
- 调整过清单的折叠设置。请检查对应清单右上角菜单中的「筛选」选项。
...
在另一层面上，属性划分了多个维度。观察属性增长的差异，可以让你思考是否需要尝试不同的领域。

其理念可参考类似以经验值计数的游戏版“一万小时定律”。
...
<p align="center">极高自定义性的游戏化自我奖惩机制！</p>
...
应用协助记录购买、限购等操作，但需要你在现实中实施真正的奖励。
...
如奖励一定数量的金币、经验值，或通过随机开箱（盲盒）抽取其他奖励等。
...
欢迎加入 QQ 群、QQ 频道，或者通过邮件咨询我们（邮箱地址 lifeup@ulives.io）。
...
我们也会非常欢迎通过 https://github.com/Ayagikei/LifeUp/issues 提交问题或建议工单。
...
- 我们想将`人升`打造为一款精致、优雅的应用。
  ...
  因此我们将保持采用买断制付费模式，**不会（针对 Pro 版本、会员）额外引入商业广告。**

- 目前`人升`有一定受众但体量仍非常小。

- 我们非常欢迎与其他优秀的独立应用互相推荐、交换友链。

- 我们非常欢迎为一些基于`人升`周边建设的推广工作，比如基于 API 设计的联动应用和网页。

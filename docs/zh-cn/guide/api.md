...
| color       | 标签颜色       | 字符串               | \#66CCFF | 否       | 需要 v1.91+<br/>注意实际使用时，# 字符需要转义。<br/>比如示例的色值实际使用时，应为 color=%2366CCFF |
...
| 参数   | 含义     | 取值          | 示例 | 是否必须 | 备注     |
| ------ | -------- | ------------- | ---- | -------- | -------- |
| amount | 存款数量 | 大于 0 的数字 | 100  | 是       | 商品名称 |
...
| 参数    | 含义       | 取值                                         | 示例 | 是否必须                | 备注                                      |
| ------- | ---------- | -------------------------------------------- | ---- | ----------------------- | ----------------------------------------- |
| key     | 查询的类型 | 仅限以下数值其一：<br/>coin<br/>atm<br/>item | coin | 是                      | coin - 当前金币数<br/>atm - 当前 ATM 存款 |

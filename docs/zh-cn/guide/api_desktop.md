...
> [!TIP]
> 2025/01/03：v1.2.0 发布后发现问题，已修复并发布 v1.2.1，请优先下载新版本。<br/>
...
- **macOS**
  ...
  - macOS 版本目前未签名，安装时需要手动允许：[打开来自身份不明开发者的 Mac App - 官方 Apple 支持 (中国)](https://support.apple.com/zh-cn/guide/mac-help/mh40616/mac)
  - macOS 版本尚未完整测试，`自动连接`等部分功能可能不可用。



> [!WARNING]
> 1. 需搭配《云人升》v2.0.0 及以上版本使用。<br/>
> 如果你使用的是中国大陆应用市场分发版本或 GitHub Release 版本，可在软件 `设置` → `实验` 中更新《云人升》。<br/>
> 如果你使用的是 Google Play 版本，也可直接前往 [Google Play 页面](https://play.google.com/store/apps/details?id=net.lifeupapp.lifeup.http) 或 [GitHub Release 页面](https://github.com/Ayagikei/LifeUp-SDK/releases/latest) 下载。

> [!WARNING]
> 2. 浏览器安全策略可能会阻止下载。你可能需要手动允许下载可执行文件，或复制链接到其他下载器。<br/>
...
**《云人升》点击“读取「人升」数据权限”后无反应，或显示 API 不存在？**
